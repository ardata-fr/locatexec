...
- [`exec_locate()`](https://ardata-fr.github.io/locatexec/dev/reference/exec_locate.md)
  : Find an executable
...
- [`is_windows()`](https://ardata-fr.github.io/locatexec/dev/reference/is_windows.md)
  : Test if the system is "Windows"
- [`is_osx()`](https://ardata-fr.github.io/locatexec/dev/reference/is_osx.md)
  : Test if the system is "macOS"
- [`is_unix()`](https://ardata-fr.github.io/locatexec/dev/reference/is_unix.md)
